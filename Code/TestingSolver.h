...
//     int npatches_y = 1;
//     int npatches_z = 1;
//     int patchsize_x = 10; //101 for the big test
//     int patchsize_y = 10; //101 for the big test
//     int patchsize_z = 10; //101 for the big test
//     int overlap = 4;
//     int fringe = 2;
//     int unknowns = 1;
//     int stages = 5;
...
//     // Creating a PDE
//     BC_LA_3D_wave bc;
//     double T = 1.0; // 0.1 for the big test, 1 for the small test
//     double a1 = 1.0;
//     double a2 = 1.0;
//     double a3 = 1.0;
...
//     // Run the solver
//     double dt = 0.05; // 0.001 for the big test, 0.05 for the small test
//     slv.solve3D(dt);  
